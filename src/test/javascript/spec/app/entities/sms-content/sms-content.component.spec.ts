...
import { SmsContentComponent } from 'app/entities/sms-content/sms-content.component';
...
describe('Component Tests', () => {
    describe('SmsContent Management Component', () => {
        let comp: SmsContentComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SmsContentComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.smsContents[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
