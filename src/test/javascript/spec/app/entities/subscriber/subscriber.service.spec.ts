    ...
    describe('Subscriber Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/subscribers';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });

            it('should create a Subscriber', () => {
                service.create(new Subscriber(null)).subscribe(received => {
            ...
            it('should update a Subscriber', () => {
                service.update(new Subscriber('123')).subscribe(received => {
