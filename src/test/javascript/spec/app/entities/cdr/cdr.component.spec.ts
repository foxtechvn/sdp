...
import { CdrComponent } from 'app/entities/cdr/cdr.component';
import { CdrService } from 'app/entities/cdr/cdr.service';
import { Cdr } from 'app/shared/model/cdr.model';

describe('Component Tests', () => {
    describe('Cdr Management Component', () => {
        let comp: CdrComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.cdrs[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
