...
import { SubProductComponent } from 'app/entities/sub-product/sub-product.component';
...
describe('Component Tests', () => {
    describe('SubProduct Management Component', () => {
        let comp: SubProductComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SubProductComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.subProducts[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
