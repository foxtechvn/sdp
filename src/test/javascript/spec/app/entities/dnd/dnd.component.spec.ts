...
import { DndComponent } from 'app/entities/dnd/dnd.component';
import { DndService } from 'app/entities/dnd/dnd.service';
import { Dnd } from 'app/shared/model/dnd.model';

describe('Component Tests', () => {
    describe('Dnd Management Component', () => {
        let comp: DndComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.dnds[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
